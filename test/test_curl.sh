...
curl -H "Content-Type: application/json" -d '{"student_internal_id":"1", "course_internal_id": "1", "mark": "77"}' http://localhost:8088/studentsApi/v1/course_mark
curl -H "Content-Type: application/json" -d '{"student_internal_id":"2", "course_internal_id": "1", "term": "1169", "program": "SE", "level": "1A"}' http://localhost:8088/studentsApi/v1/student_enrolment
