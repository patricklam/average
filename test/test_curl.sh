#!/bin/sh
curl -H "Content-Type: application/json" -d '{"uwid":"99119924", "firstname": "r12", "lastname": "ttt"}' http://localhost:8088/studentsApi/v1/student
curl -H "Content-Type: application/json" -d '{"uwid":"99119923", "firstname": "q11", "lastname": "rss"}' http://localhost:8088/studentsApi/v1/student
